...
const PageActionButtonsComponent: React.FC<PageActionButtonsProps> = ({
  ...
  const entityConfig = {
    ...
    workflowAmountStageOverride: {
      ...
      permissions: ["workflow_amount_stage_override_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    developerBeneficiary: {
    ...
    party: {
      ...
      permissions: ["master_party_create"], // Only users with party_create permission
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    accountPurpose: {
      ...
      permissions: ["master_account_purpose_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    investmentType: {
      ...
      permissions: ["master_investment_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    businessSegment: {
      ...
      permissions: ["master_business_segment_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    businessSubSegment: {
      ...
      permissions: ["master_business_sub_segment_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    agreementType: {
      ...
      permissions: ["master_agreement_type_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    agreementSubType: {
      ...
      permissions: ["master_agreement_sub_type_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    productProgram: {
      ...
      permissions: ["master_product_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    beneficiary: {
      ...
      permissions: ["master_beneficiary_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    agreementSegment: {
      ...
      permissions: ["master_agreement_segment_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    ...
    generalLedgerAccount: {
      ...
      permissions: ["master_general_ledger_account_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    country: {
      ...
      permissions: ["master_country_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    currency: {
      ...
      permissions: ["master_currency_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    agreement: {
      ...
      route: "/agreement/new",
      permissions: ["entities_agreement_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    agreementParameter: {
      ...
      permissions: ["entities_agreement_parameter_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    agreementFeeSchedule: {
      ...
      permissions: ["entities_agreement_fee_schedule_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    agreementAccount: {
      ...
      permissions: ["entities_agreement_account_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    escrowAgreementSignatory: {
      ...
      permissions: ["entities_agreement_signatory_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    paymentBeneficiary: {
      label: "Add New Payment Beneficiary",
      route: "payment/payment-beneficiary/new",
      permissions: ["payment_beneficiary_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
    paymentInstruction: {
      ...
      permissions: ["payment_instruction_create"], // Temporarily set to allow all users
      downloadPermission: ["data_export"], // Unified download permission
      uploadPermission: ["bulk_upload"], // Unified upload permission
    },
  ...
  if (!config && process.env.NODE_ENV === "development") {
    console.error(
      `[PageActionButtons] No config found for entityType: ${entityType}. Available types:`,
