...
const Step3 = ({
  ...
  const [agreementSignatoryDetails, setAgreementSignatoryDetails] =
  ...
  useEffect(() => {
    const fetchAllData = async () => {
      if (!agreementSignatoryId) {
        setError('Agreement Signatory ID is required')
        setLoading(false)
        return
      }
      ...
      try {
        ...
        setAgreementSignatoryDetails(detailsResult as AgreementSignatory)
