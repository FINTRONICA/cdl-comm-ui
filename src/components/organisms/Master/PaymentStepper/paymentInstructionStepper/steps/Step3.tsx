...
const Step3 = ({
  ...
  const paymentInstructionId =
    propPaymentInstructionId || (params.id as string);
  const isDarkMode = useIsDarkMode();

  const [paymentInstructionDetails, setPaymentInstructionDetails] =
  ...
  useEffect(() => {
    const fetchAllData = async () => {
      if (!paymentInstructionId || paymentInstructionId.trim() === "") {
        console.warn(
          "[Step3] Payment Instruction ID is missing or empty:",
      ...
      >
        <CardContent sx={{ p: 3 }}>
          ...
          >
            ...
            >
              {getPaymentInstructionLabelDynamic(
                "CDL_PAYMENT_STANDING_INSTRUCTION"
              )}
            </Typography>
            {!isReadOnly && (
              <Button
          ...
          <Grid container spacing={3}>
            ...
            {paymentInstructionDetails.creditAmountCap !== undefined &&
              paymentInstructionDetails.creditAmountCap !== null && (
                <Grid size={{ xs: 12, md: 6 }}>
                  {renderDisplayField(
                    getPaymentInstructionLabelDynamic(
            ...
            {paymentInstructionDetails.creditAmount !== undefined &&
              paymentInstructionDetails.creditAmount !== null && (
                <Grid size={{ xs: 12, md: 6 }}>
                  {renderDisplayField(
                    getPaymentInstructionLabelDynamic(
            ...
            {paymentInstructionDetails.priority !== undefined &&
              paymentInstructionDetails.priority !== null && (
                <Grid size={{ xs: 12, md: 6 }}>
                  {renderDisplayField(
                    getPaymentInstructionLabelDynamic(
            ...
            {paymentInstructionDetails.recentPercentage !== undefined &&
              paymentInstructionDetails.recentPercentage !== null && (
                <Grid size={{ xs: 12, md: 6 }}>
                  {renderDisplayField(
                    getPaymentInstructionLabelDynamic(
