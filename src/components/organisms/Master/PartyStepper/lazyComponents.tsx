...
export const preloadNextStep = (currentStep: number) => {
  const preloadMap: Record<number, () => Promise<{ default: React.ComponentType<Record<string, unknown>> }>> = {
    0: preloadSteps.step2 as () => Promise<{ default: React.ComponentType<Record<string, unknown>> }>,
    1: preloadSteps.step2 as () => Promise<{ default: React.ComponentType<Record<string, unknown>> }>, // Preload Authorized Signatory after Documents
    2: preloadSteps.step3 as () => Promise<{ default: React.ComponentType<Record<string, unknown>> }>, // Preload Review after Authorized Signatory
  }
