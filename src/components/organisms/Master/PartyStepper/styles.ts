...
import {
  ...
  nextButtonSx as projectNextButtonSx,
  primaryButtonSx as projectPrimaryButtonSx,
  viewModeInputStyles as projectViewModeInputStyles,
  neutralBorder as projectNeutralBorder,
  neutralBorderHover as projectNeutralBorderHover,
} from '../styles'

// Re-export directly - these are already functions from the main styles file
...
export const viewModeInputStyles = projectViewModeInputStyles

export const neutralBorder = projectNeutralBorder

export const neutralBorderHover = projectNeutralBorderHover