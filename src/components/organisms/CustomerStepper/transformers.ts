...
export const useCustomerStepDataTransformers = () => {
  return useMemo(() => ({
    1: (formData: CustomerData) => ({
      customerId: formData.customerId,
      cifExist: formData.cifExist,
      partyCif: formData.partyCif,
      personName: formData.personName,
      partyName: formData.partyName,
      personAddress1: formData.personAddress1,
      personAddress2: formData.personAddress2,
      personAddress3: formData.personAddress3,
      telephoneNo: formData.telephoneNo,
      mobileNo: formData.mobileNo,
      emailId: formData.emailId,
      cifOfPerson: formData.cifOfPerson,
      noticePerson: formData.noticePerson,
      noticePersonEmailId: formData.noticePersonEmailId,
      noticePersonSignature: formData.noticePersonSignature,
      cif: formData.cif,
      ...
      partyConstituent: formData.partyConstituent,
      role: formData.role,
      rmName: formData.rmName,
      backupProjectAccountOwner: formData.backupProjectAccountOwner,
      projectAccountOwner: formData.projectAccountOwner,
      armName: formData.armName,
      teamLeader: formData.teamLeader,
      remarks: formData.remarks,
    }),
    2: (formData: CustomerData) => ({
      partySignatories: formData.partySignatories || [],
    }),
    3: (formData: CustomerData) => ({
      documents: formData.documents || [],
    }),
    4: (formData: CustomerData) => ({
      reviewData: formData,
      termsAccepted: true,
    }),
  }), [])
...
export const transformCustomerStepData = (
  step: number, 
  formData: CustomerData, 
  transformers: ReturnType<typeof useCustomerStepDataTransformers>
) => {
