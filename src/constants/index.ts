...
export const APP_CONFIG = {
  name: 'Escrow Central',
  version: '1.0.0',
  description: 'Financial commercial management system',
...
export const ROUTES = {
  ...
  businessSubSegment: '/business-sub-segment',
  agreementSegment: '/agreement-segment',
  agreementType: '/agreement-type',
  agreementSubType: '/agreement-sub-type',
  ...
  agreementParameter: '/agreement-parameter',
  agreementFeeSchedule: '/agreement-fee-schedule',
  escrowAccount: '/escrow-account',
  paymentBeneficiary: '/payment-beneficiary',
...
export const TEMPLATE_FILES = {
  ESCROW_ACCOUNT: 'EscrowAccountTemplate.xlsx',
