...
import { RightSlideProductPanel } from '@/components/organisms/RightSlidePanel/customerSlidePanel/RightSlideProduct'
    ...
    <div className="w-full max-w-md text-center">
      <div className="mb-8">
        ...
        <h1 className="mb-4 text-2xl font-semibold text-gray-900">
          Failed to load product programs
        </h1>
...
const ProductProgramPageClient = dynamic(
...
const LoadingSpinner: React.FC = () => (
  <div className="flex items-center justify-center min-h-screen bg-gray-50">
    <div className="text-center">
      <Spinner size="lg" />
      <p className="mt-4 text-gray-600">Loading product programs...</p>
    </div>
  </div>
)
...
const ProductProgramPageImpl: React.FC = () => {
  ...
  // Dummy data for product programs
  const productProgramData = useMemo(() => [
    {
      id: 1,
      productProgramId: 'PP001',
      productProgramName: 'Premium Banking',
      productProgramDescription: 'Premium banking services for high-value customers',
    },
    {
      id: 2,
      productProgramId: 'PP002',
      productProgramName: 'Business Banking',
      productProgramDescription: 'Comprehensive business banking solutions',
    },
    {
      id: 3,
      productProgramId: 'PP003',
      productProgramName: 'Investment Services',
      productProgramDescription: 'Investment advisory and portfolio management',
    },
    {
      id: 4,
      productProgramId: 'PP004',
      productProgramName: 'Digital Banking',
      productProgramDescription: 'Online and mobile banking platforms',
    },
    {
      id: 5,
      productProgramId: 'PP005',
      productProgramName: 'Corporate Finance',
      productProgramDescription: 'Corporate finance and advisory services',
    },
  ] as ProductProgramData[], [])

  const getProductProgramLabelDynamic = useCallback(
    (configId: string): string => {
      return getProductProgramLabel(configId)
    },
    []
  )
  ...
  const tableColumns = [
    {
      ...
      label: getProductProgramLabelDynamic('CDL_CS_PRODUCT_PROGRAM_ID'),
      type: 'text' as const,
      width: 'w-48',
      sortable: true,
    },
    {
      ...
      label: getProductProgramLabelDynamic('CDL_CS_PRODUCT_PROGRAM_NAME'),
      type: 'text' as const,
      width: 'w-48',
      sortable: true,
    },
    {
      ...
      label: getProductProgramLabelDynamic('CDL_CS_PRODUCT_PROGRAM_DESCRIPTION'),
      type: 'text' as const,
      width: 'w-64',
      sortable: true,
    },
  ...
  const handleRowView = (row: ProductProgramData) => {
    setEditingItem(row)
    setPanelMode('edit')
    setIsPanelOpen(true)
  }
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            <span className="text-gray-600">
              {getProductProgramLabelDynamic('CDL_CS_PRODUCT_PROGRAM_ID')}:
            </span>
          ...
          <div>
            <span className="text-gray-600">
              {getProductProgramLabelDynamic('CDL_CS_PRODUCT_PROGRAM_NAME')}:
            </span>
            <span className="ml-2 font-medium text-gray-800">
          ...
          <div className="col-span-2">
            <span className="text-gray-600">
              {getProductProgramLabelDynamic('CDL_CS_PRODUCT_PROGRAM_DESCRIPTION')}:
            </span>
            <span className="ml-2 font-medium text-gray-800">
  ...
  return (
    <>
      ...
      <CommentModal
        ...
        message={`Are you sure you want to delete this product program?`}
        actions={[
          {
            label: 'Cancel',
