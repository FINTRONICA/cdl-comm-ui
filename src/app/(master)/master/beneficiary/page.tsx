...
const BeneficiariesPageImpl: React.FC = () => {
  ...
  const isRefreshLoading = isRefreshing || beneficiariesFetching;
  const showRefreshOverlay = isRefreshLoading || beneficiariesLoading;
  ...
  }, [isRefreshing, refetchBeneficiaries]);


  if (beneficiariesLoading || beneficiariesFetching) {
    return (
