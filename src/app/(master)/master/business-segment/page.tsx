...
const BusinessSegmentPageImpl: React.FC = () => {
  ...
  const {
    ...
    isFetching: businessSegmentsFetching,
  ...
  const isRefreshLoading = isRefreshing || businessSegmentsFetching;
  const showRefreshOverlay = isRefreshLoading || businessSegmentsLoading;
  ...
  const handleRefresh = useCallback(async () => {
    ...
    try {
      await refreshBusinessSegments();
    } finally {
      setIsRefreshing(false);
    }
  }, [isRefreshing, refreshBusinessSegments]);

  if (businessSegmentsLoading || businessSegmentsFetching) {
    return (
