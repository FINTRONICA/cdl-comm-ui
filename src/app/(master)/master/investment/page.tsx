...
const InvestmentPageImpl: React.FC = () => {
  ...
  const isRefreshLoading = isRefreshing || investmentsFetching;
  const showRefreshOverlay = isRefreshLoading || investmentsLoading;
  ...
  }, [isRefreshing, refreshInvestments]);

  if (investmentsLoading || investmentsFetching) {
    return (
