...
const MasterReportPage = () => {
  ...
  const reportsData: ReportCategory[] = useMemo(() => {
    const masterReportIds = [
      'charges',
      'beneficiaryReport',
      'documentReport',
      'dealSegmentReport',
    ...
    const categories: ReportCategory[] = [
      {
        ...
        reports: [
          {
            id: 'charges',
            title: BUSINESS_REPORTS_CONFIG['charges']?.title || 'Customer Report',
            icon: (
              <FileUser
      ...
      },
      {
        ...
        reports: [
          ...
          },
          {
            ...
            title:
              BUSINESS_REPORTS_CONFIG['dealAmendmentVerificationReport']
      ...
      },
      {
        ...
        reports: [
          ...
          },
          {
            ...
            title:
              BUSINESS_REPORTS_CONFIG['unitaryPaymentVerificationReport']
    ...
    return categories
      .map((category) => ({
        ...
        reports: category.reports.filter(
          (report) =>
            masterReportIds.includes(report.id) &&
            BUSINESS_REPORTS_CONFIG[report.id] !== undefined
        ),
      }))
  ...
  const handleReportClick = (report: Report) => {
    router.push(`/reports/master/${report.id}`)
  }
