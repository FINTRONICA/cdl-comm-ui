...
// Custom Dayjs schema validator with auto-conversion (for future use)
// Uncomment when date fields are needed
/*
...
// Agreement Step 1: Basic Details Schema
...
export const validateAgreementStepData = (stepNumber: number, data: unknown) => {
