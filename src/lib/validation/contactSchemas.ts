...
export const contactValidationSchema = z.object({
  ...
  bpcContactmpaddressLine1: z.string().max(30, 'Address Line 1 must be 30 characters or less').optional(),
  bpcContactmpaddressLine2: z.string().max(30, 'Address Line 2 must be 30 characters or less').optional(),
