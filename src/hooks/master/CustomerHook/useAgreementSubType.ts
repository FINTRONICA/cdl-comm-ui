...
export function useDeleteAgreementSubType() {
  ...
  return useMutation({
    mutationFn: (id: string) =>
      agreementSubTypeService.deleteAgreementSubType(id),
    onSuccess: () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (isEditing && agreementSubTypeId) {
        return agreementSubTypeService.updateAgreementSubType(
          agreementSubTypeId,
          data as UpdateAgreementSubTypeRequest
        );
      } else {
        return agreementSubTypeService.createAgreementSubType(
          data as CreateAgreementSubTypeRequest
        );
      }
    },
    onSuccess: () => {
