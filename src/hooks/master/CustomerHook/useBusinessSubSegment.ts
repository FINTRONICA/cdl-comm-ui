...
export function useDeleteBusinessSubSegment() {
  ...
  return useMutation({
    mutationFn: (id: string) =>
      businessSubSegmentService.deleteBusinessSubSegment(id),
    onSuccess: () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (isEditing && businessSegmentId) {
        return businessSubSegmentService.updateBusinessSubSegment(
          businessSegmentId,
          data as UpdateBusinessSubSegmentRequest
        );
      } else {
        return businessSubSegmentService.createBusinessSubSegment(
          data as CreateBusinessSubSegmentRequest
        );
      }
    },
    onSuccess: () => {
