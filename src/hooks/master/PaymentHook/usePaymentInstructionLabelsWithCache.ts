...
import type { ProcessedPaymentInstructionLabels } from '@/services/api/masterApi/Payment/paymentInstructionLabelsService'
...
export function usePaymentInstructionLabelsWithCache() {
  ...
  const paymentInstructionLabels = null as ProcessedPaymentInstructionLabels | null
  const paymentInstructionLabelsLoading = false
